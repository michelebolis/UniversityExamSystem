...
![ER](https://github.com/michelebolis/UniversityExamSystem/blob/main/documentazione/img/ER_raw.png?raw=True)  
...
L'entità _studente_, che rappresenta gli studenti iscritti attualmente nell'università in un _corso di laurea_, è in relazione con l'entità _immatricolazione_ che contiene la matricola, con cui identifichiamo lo studente e la data in cui è avvenuta l'immatricolazione.  Differenziamo l'immatricolazione, come l'assegnamento della matricola ad uno studente alla prima iscrizione, e l'iscrizione ad un corso di laurea, in questo modo i dati in _immatricolazione_ rimarranno invariati nel tempo mentre solo in _studente_ inseriremo o cancelleremo l'iscrizione di uno studente  
Prevediamo di voler ricavare attraverso il codice fiscale, che consideriamo unico, la matricola di un ex-studente in modo tale che, nonostante non sia piu presente nell'entità _studente_, nel caso di una nuova iscrizione ad un nuovo corso di laurea, gli venga riassegnata la sua precedente matricola cosicchè non si creino nuove matricole e sia possibile recuperare gli esiti di vecchi esami superati mantenendone la validità. In questo modo cancellando i dati da studente non precludiamo l'accesso agli ex-studenti alla base di dati.  
...
![studente_home](https://github.com/michelebolis/UniversityExamSystem/blob/main/documentazione/img/studente_homev2.png?raw=True)  
...
![exstudente_home](https://github.com/michelebolis/UniversityExamSystem/blob/main/documentazione/img/exstudente_homev2.png?raw=True)  
...
![exstudente_carriera](https://github.com/michelebolis/UniversityExamSystem/blob/main/documentazione/img/exstudente_carrierav2.png?raw=True)  
