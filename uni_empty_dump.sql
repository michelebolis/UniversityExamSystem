...
-- insert_utente
CREATE OR REPLACE PROCEDURE uni.insert_utente(ruolo ruolo, nome varchar(50), cognome varchar(50), new_email varchar(100), password varchar(32), cellulare varchar(20)) 
AS $$
BEGIN 
