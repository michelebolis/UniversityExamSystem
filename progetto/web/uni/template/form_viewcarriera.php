<form class="col-6 offset-1" method="POST" action=<?php echo $_SERVER['PHP_SELF'].'?carriera=True';?>>
<?php
    if (isset($_SESSION['ruolo']) && $_SESSION['ruolo']=='Studente'){
        include_once('lib/print_carriera.php');
        print_carriera($info['matricola'], $info['idcorso']);
...
<?php 
        ...
        include_once('lib/print_carriera.php');
        print_carriera($matricola, $corso);
    }
?>
</form>